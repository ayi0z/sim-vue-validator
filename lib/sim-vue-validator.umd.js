(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["sim-vue-validator"] = factory();
	else
		root["sim-vue-validator"] = factory();
...
// EXTERNAL MODULE: ./plugin/sim-vue-validator.css
var sim_vue_validator = __webpack_require__("8a8a");
  ...
  Vue.directive('sim-valid', {
    inserted: function inserted(el, binding, vnode) {
      if (!vnode.context['isReValidPassed']) {
        vnode.context['isReValidPassed'] = function () {
          for (var a = 0, els = document.querySelectorAll("*[data-re-valid]"); a < els.length; a++) {
    ...
    componentUpdated: function componentUpdated(el, binding, vnode) {
      ...
      if (typeof binding.value == 'function') {
        ...
        var passed = !regexp || regexp.test(elValue);
        var isrequired = passed && el.getAttribute('required');
        passed = isrequired ? elValue && elValue.toString().trim() : passed;
        var minlen = passed && el.getAttribute('minlength');
        passed = minlen ? elValue.replace(/[^\x00-\xff]/g, 'aa').length >= minlen : passed;
        var maxlen = passed && el.getAttribute('maxlength');
        passed = maxlen ? elValue.replace(/[^\x00-\xff]/g, 'aa').length <= maxlen : passed; // 校验结果写入 el 的data属性

        el.setAttribute('data-re-valid', passed || false); // 指令参数指定了校验不通过时的classname，如果指令参数没有设置，则添加默认classname
...
//# sourceMappingURL=sim-vue-validator.umd.js.map